...
plot(dat$DateTime,dat$Global_active_power,type="line",
     ylab = "Global Active Power (kilowatts)",xlab = "")

#plot Voltage
plot(dat$DateTime,dat$Voltage,type="line",
...
points(dat$DateTime,dat$Sub_metering_1,type = "line")
points(dat$DateTime,dat$Sub_metering_2,type = "line",col="Red")
points(dat$DateTime,dat$Sub_metering_3,type = "line",col="Blue")
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       lty = 1,col = c("black","Red","Blue"),cex = .65,pt.cex = .65)


#plot Global reactive power
plot(dat$DateTime,dat$Global_reactive_power,type="line",
